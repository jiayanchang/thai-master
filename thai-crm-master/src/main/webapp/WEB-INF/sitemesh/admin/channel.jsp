	...
	<div class="container-fluid">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				...
				<li role="presentation"><a href="${pageContext.request.contextPath}/a/order/list">订单管理</span></a></li>
				<!--<li role="presentation"  class="active"><a class="navbar-brand" href="#">渠道管理</a></li>  -->
				<li role="presentation"  class="dropdown-toggle"><a style='color:#FFF;' href="#">渠道管理</a></li>
