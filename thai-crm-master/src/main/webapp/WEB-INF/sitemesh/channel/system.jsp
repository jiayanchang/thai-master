	...
	<div class="container-fluid">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				<li role="presentation"><a href="${pageContext.request.contextPath}/c/order/list">订单管理</a></li>
	...
	<div class="row">
		<div class="col-sm-3 col-md-2 sidebar">
			<ul class="nav nav-sidebar">
				<li><a href="${pageContext.request.contextPath}/c/user/list">用户查询</a></li>
				<li><a href="${pageContext.request.contextPath}/c/user/add">新建用户</a></li>
			</ul>
		</div>
