...
public class ChannelUserController {
	...
	/*
	 * @RequestMapping(method=RequestMethod.POST) public String processSubmit(@ModelAttribute("ucd") UserControllerDomain ucd, BindingResult
	 ...
	 * if(result.hasErrors()){
	 * 
	 * return "userView"; }else{ status.setComplete(); userService.create(DomainControllertoDomain.UserControllertoUser(ucd)); return
	 * "userSuccess"; } }
	 * 
	 * 
	 * @RequestMapping(method=RequestMethod.GET) public String initForm(ModelMap model) { // TODO Auto-generated method stub
	 * UserControllerDomain ucd = new UserControllerDomain(); ucd.setJob("1"); model.addAttribute("ucd",ucd); return "userView";
	 * 
	 * }
	 */
