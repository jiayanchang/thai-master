...
@Entity
@Table(name = "log_channel_order")
public class ChannelOrderLog {

	public ChannelOrderLog() {

	}

	public ChannelOrderLog(int orderId, User user, String content) {
	...
	public ChannelOrderLog(MerchantOrder order, User user, String content) {
