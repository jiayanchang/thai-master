...
@Entity
@Table(name = "merchant_order_notes")
public class MerchantOrderNotes {

	public MerchantOrderNotes() {

	}

	public MerchantOrderNotes(int orderId, User user, String content) {
	...
	public MerchantOrderNotes(MerchantOrder order, User user, String content) {
		this(order.getId(), user, content);
	}

	public MerchantOrderNotes(MerchantOrder order, User user, String content, Date lockdate) {
		this(order.getId(), user, content);
		this.lockedDate = lockdate;
	}

	public MerchantOrderNotes(MerchantOrder order, Channel channel, String content) {
